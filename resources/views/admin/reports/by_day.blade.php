...
@endsection
@section('breadcumb')
      <li class="active">{{ trans('report.daily_electrical_report') }}</li> 
@endsection
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-body">
          {{Form::open(['route'=>'electrical_report_by_day','method'=>'get','class'=>'form-inline'])}}
                  ...
                  <div class="form-group">
                    {{Form::label('date',trans('report.month'),['class'=>'control-label'])}}
                    <div class='input-group date' id='datetimepicker9'>
                        <input name="date" type='text' class="form-control" readonly value="{{$month}}-{{$year}}" />
                  ...
                  <span>
                  {{Form::submit(trans('form.search'),['class'=>'btn btn-primary'])}}</span>
          {{Form::close()}}
        </div>  
      </div>
    </div>      
