...
@endsection
@section('breadcumb')
		  <li class="active">{{ trans('report.monthly_electrical_report') }}</li> 
@endsection
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-body">
          {{Form::open(['route'=>'electrical_report_by_month','method'=>'get','class'=>'form-inline'])}}
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    {{Form::label('date',trans('report.year'),['class'=>'control-label'])}}
                    <div class='input-group date' id='datetimepicker9'>
                        <input name="date" type='text' class="form-control" readonly value="{{$year}}" />
