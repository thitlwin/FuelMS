...
@section('contentheader')
  ...
  @section('contentheader_title') 
      <h4>{{ trans('report.wh_reports')}} [{{trans('report.report_by_day')}}]</h4>      
  @endsection 
@endsection
@section('breadcumb')
      <li>{{ trans('report.wh_reports') }}</li> 
      <li class="active">{{ trans('report.report_by_day') }}</li> 
@endsection
    ...
    <div class="row">
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          {{Form::open(['route'=>'wh_report_by_day','method'=>'get','class'=>'form-inline'])}}
          @if(Auth::user()->user_type_id==2)
                <div class="form-group">
                    {{Form::label('location_id',trans('report.location'),['class'=>'control-label','id'=>'search_form'])}}                    
              ...
              @endif
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    {{Form::label('month_year',trans('report.month'),['class'=>'control-label'])}}
                    <div class='input-group date' id='month_year'>
                        <input name="month_year" id="start_time" type='text' class="form-control" readonly value="{{$month_year}}" />
