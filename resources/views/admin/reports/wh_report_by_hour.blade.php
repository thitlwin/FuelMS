...
@section('contentheader')
  ...
  @section('contentheader_title') 
      <h4>{{ trans('report.wh_reports')}} [{{trans('report.report_by_hour')}}]</h4>      
  @endsection 
@endsection
@section('breadcumb')
      <li>{{ trans('report.wh_reports') }}</li> 
      <li class="active">{{ trans('report.report_by_hour') }}</li> 
@endsection
    ...
    <div class="row">
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          {{Form::open(['route'=>'wh_report_by_hour','method'=>'get','class'=>'form-inline'])}}
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class='input-group date' id='date'>
                        <input name="date" id="start_time" type='text' class="form-control" readonly value="{{$date}}" />
